		...
		<div className="container">
			...
			<div className="row product-lists">
				...
				<div className="col-lg-4 col-md-6 text-center">
					<div className="single-product-item">
						<div className="product-image">
							<a href="single-product.html"><img src="/public/assets/img/products/product-img-4.jpg" alt=""/></a>
						</div>
						<h3>Avocado</h3>
				...
				<div className="col-lg-4 col-md-6 text-center">
					<div className="single-product-item">
						<div className="product-image">
							<a href="single-product.html"><img src="/public/assets/img/products/product-img-5.jpg" alt=""/></a>
						</div>
						<h3>Green Apple</h3>
				...
				<div className="col-lg-4 col-md-6 text-center strawberry">
					<div className="single-product-item">
						<div className="product-image">
							<a href="single-product.html"><img src="/public/assets/img/products/product-img-6.jpg" alt=""/></a>
						</div>
						<h3>Strawberry</h3>
