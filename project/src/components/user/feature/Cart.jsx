						...
						<table className="cart-table">
							...
							<tbody>
								<tr className="table-body-row">
									...
									<td className="product-image"><img src="/public/assets/img/products/product-img-1.jpg" alt=""/></td>
								...
								<tr className="table-body-row">
									<td className="product-remove"><a href="#"><i className="far fa-window-close"></i></a></td>
									<td className="product-image"><img src="/public/assets/img/products/product-img-2.jpg" alt=""/></td>
								...
								<tr className="table-body-row">
									<td className="product-remove"><a href="#"><i className="far fa-window-close"></i></a></td>
									<td className="product-image"><img src="/public/assets/img/products/product-img-3.jpg" alt=""/></td>
