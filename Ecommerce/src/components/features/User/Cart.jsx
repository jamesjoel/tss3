                                ...
                                <tbody>
                                    <tr>
                                        <td className="cart_product_img">
                                            <a href="#"><img src="public/assets/img/bg-img/cart1.jpg" alt="Product"/></a>
                                        </td>
                                    ...
                                    <tr>
                                        <td className="cart_product_img">
                                            <a href="#"><img src="public/assets/img/bg-img/cart2.jpg" alt="Product"/></a>
                                        </td>
                                        <td className="cart_product_desc">
                                    ...
                                    <tr>
                                        <td className="cart_product_img">
                                            <a href="#"><img src="public/assets/img/bg-img/cart3.jpg" alt="Product"/></a>
                                        </td>
                                        <td className="cart_product_desc">
                                            <h5>Minimal Plant Pot</h5>
                                        </td>
                    ...
                    <div className="col-12 col-lg-4">
                        <div className="cart-summary">
                            ...
                            <div className="cart-btn mt-100">
                                <NavLink to="/Login" className="btn amado-btn w-100">My Account</NavLink>
                            </div>
                        </div>
                    </div>
                </div>
